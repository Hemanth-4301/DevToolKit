...
// Animated pencil-drawing-a-circle loader, shown for encode/decode work in
// the Base64 Converter so a fast operation doesn't just flash a spinner.
export default function PencilLoader({ label, className }) {
  return (
    <div className={cn("flex flex-col items-center gap-3", className)}>
      <svg
        viewBox="0 0 200 200"
        className="pencil-loader h-20 w-20 sm:h-24 sm:w-24"
      >
        <defs>
